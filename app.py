...
def highlight_html(orig, rew):
    ...
    for t in re.split(r'(\s+|\n+)', rew):
        ...
        if c and c not in STOP and c not in os_:
            parts.append(f'<span class="cw">{t}</span>')
        else:
            parts.append(t)
    return ''.join(parts)
...
.cw{background:rgba(251,191,36,0.15);color:#fbbf24;border-bottom:1.5px solid rgba(251,191,36,0.5);border-radius:4px;padding:1px 4px;font-weight:500;}
...
<div class="wrap">
  <div class="hdr">
    ...
    <div class="pills">
      <span class="pill"><span class="dot dot-a"></span>Developed by: <b>Ghulam Awais</b></span>
